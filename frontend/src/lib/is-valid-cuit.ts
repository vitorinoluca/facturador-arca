...
// Algoritmo oficial de AFIP/ARCA. Duplicado del equivalente en el backend
// (backend/src/common/is-valid-cuit.ts) — no hay paquete compartido entre
// frontend y backend en este repo.
